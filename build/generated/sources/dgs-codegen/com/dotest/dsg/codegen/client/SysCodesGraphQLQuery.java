...
public class SysCodesGraphQLQuery extends GraphQLQuery {
  public SysCodesGraphQLQuery(SysCodeQuery query, String queryName, Set<String> fieldsSet) {
  ...
  public static class Builder {
    ...
    private SysCodeQuery query;

    private String queryName;

    public SysCodesGraphQLQuery build() {
      return new SysCodesGraphQLQuery(query, queryName, fieldsSet, variableReferences, variableDefinitions);
               
    }

    public Builder query(SysCodeQuery query) {
      this.query = query;
    ...
    public Builder queryReference(String variableRef) {
      ...
      this.variableDefinitions.add(graphql.language.VariableDefinition.newVariableDefinition(variableRef, new graphql.language.TypeName("SysCodeQuery")).build());
      this.fieldsSet.add("query");
      return this;
    }
